...
function main() {
    const inboxButtonEl = document.querySelector(".inbox");
    const sentButtonEl = document.querySelector(".sent");
    const mailButton1El = document.querySelector(".mm1");
    const mailButton2El = document.querySelector(".mm2");
    ...
    window.addEventListener("load", function() {
        (0, _handleRoute.handleRoute)(this.location.pathname);
    });
}
main();

},{"./handle-route":"41l9H"}],"41l9H":[function(require,module,exports) {
...
},{}]},["bf3Nq","h7u1C"], "h7u1C", "parcelRequire90d9")
